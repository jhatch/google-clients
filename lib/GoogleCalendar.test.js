...
describe('[class] GoogleCalendar', () => {
  ...
  describe('[method] getScheduledDate', () => {
    it('should return null if email is not on any future events', () => {
      ...
      expect(calendar.getScheduledDate('bob.dole@gmail.com')).to.equal(null);
    });
    ...
    it('should return null if email is only on a past event', () => {
      ...
      expect(calendar.getScheduledDate('john.doe@gmail.com')).to.equal(null);
    });
    ...
    it('should return the date if email is on a future event', () => {
      ...
      expect(calendar.getScheduledDate('john.doe@gmail.com')).to.equal(date);
    });
