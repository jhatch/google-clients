...
describe('[class] GoogleCalendar', () => {
  ...
  describe('[method] getScheduledEvent', () => {
    it('should return null if email is not on any future events', () => {
      ...
      expect(calendar.getScheduledEvent('bob.dole@gmail.com')).to.equal(null);
    });
    ...
    it('should return null if email is only on a past event', () => {
      ...
      expect(calendar.getScheduledEvent('john.doe@gmail.com')).to.equal(null);
    });
    ...
    it('should return the date if email is on a future event', () => {
      ...
      expect(calendar.getScheduledEvent('john.doe@gmail.com')).to.deep.equal({
        date,
        summary: 'Event.',
      });
    });
